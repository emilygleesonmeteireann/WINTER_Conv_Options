...
v[5] = v[5].reverse()
t[5] = v[5]
v[6] = ['Wopt_F_SC_T_SA_F','Wopt_F_SC_F_SA_F','Wopt_F_SC_T_SA_T','Wopt_T_SC_T_SA_F','Wopt_T_SC_T_SA_T']
t[6] = ['Wopt_F_SC_T_SA_F','Wopt_F_SC_F_SA_F','Wopt_F_SC_T_SA_T','Wopt_T_SC_T_SA_F','Wopt_T_SC_T_SA_T']
v[7] = ['ALL','00','12'] ;
t[7] = v[7] ;
